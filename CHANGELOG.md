...
- Laser settings likewise: `config/hardware/lasers/production_lasers.py` is a standard Benchtop mesoSPIM on an NI card, and `demo_lasers.py` includes it and only switches `laser`/`shutter` to `'Demo'`.
