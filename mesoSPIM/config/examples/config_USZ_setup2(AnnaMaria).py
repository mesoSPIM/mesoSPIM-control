...
filterdict = {'Empty-Alignment' : (0,0),
              'F39 508SG 509 22' : (1,0),
              'F37 520SG 520 35 BL HC' : (2,0),
              'F75 562SG RAZOR EDGE LP' : (3,0),
              '450 50' : (4,0),
              '405 445 514 561 640' : (5,0),
              '460LP' : (6,0),
              'F37 542SG 452 27' : (7,0),
              'F37 535SG 530 43' : (8,0),
              'F76 647SG LP' : (9,0),
              'F37 565SG 565 24' : (0,1),
             }
