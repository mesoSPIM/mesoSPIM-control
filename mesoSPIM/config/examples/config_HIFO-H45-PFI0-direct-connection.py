...
ui_options = {'dark_mode' : True, # Dark mode: Renders the UI dark if enabled
			  ...
			  'flip_XYZFT_button_polarity': (False, True, False, True, False),
               }
...
'''
camera = 'HamamatsuOrca' # 'DemoCamera' or 'HamamatsuOrcaFlash' or 'PhotometricsCamera'
...
stage_parameters = {'stage_type' : 'PI_rotz_and_Galil_xyf', # 'DemoStage' or 'PI' or other configs found in mesoSPIM_serial.py
                    'startfocus' : -14500,
                    'y_load_position': -31000,
                    ...
                    'z_center_position': 66000, # z-center position for the sample holder. Make sure the sample holder is actually centered at this position relative to the detection objective and light-sheet.
                    'x_max' : 51000,
                    'x_min' : -46000,
                    'y_max' : 0,
                    'y_min' : -100000,
...
'''old PI parameters (before removing the M-605 additional focus stage)
pi_parameters = {'controllername' : 'C-884',
                'stages' : ('M-061.PD','M-406.4PD','M-605.2DD'),
                'refmode' : ('FRF',),
                'serialnum' : ('118015799'), #0185500834
                'velocity': {1: 22.5, 2: 3, 3: 3}, # in mm/s or °/s
                }
'''
...
pi_parameters = {'controllername' : 'C-884',
                ...
                'refmode' : ('FRF',),
                'serialnum' : ('118015799'), #0185500834
                'velocity': {1: 22.5, 2: 3}, # in mm/s or °/s
                }
...
'''
filterwheel_parameters = {'filterwheel_type' : 'Ludl', # 'DemoFilterWheel' or 'Ludl'
                          'COMport' : 'COM2'}
...
'''
zoom_parameters = {'zoom_type' : 'Dynamixel', # 'DemoZoom' or 'Dynamixel'
                   'servo_id' :  4,
                   'COMport' : 'COM5',
                   'baudrate' : 1000000}
...
hdf5 = {'subsamp': ((1, 1, 1),), #((1, 1, 1),) no subsamp, ((1, 1, 1), (1, 4, 4)) for 2-level (z,y,x) subsamp.
        ...
        'flip_xyz': (False, True, False), # match BigStitcher coordinates to mesoSPIM axes.
		'transpose_xy': False
        }
