...
laserdict = {'405 nm': 'PXI6733/port0/line2',
             ...
             '594 nm': 'PXI6733/port0/line5',
             '647 nm': 'PXI6733/port0/line6'}
...
shutterswitch = False # assumes that the shutter_left line is the general shutter
shutteroptions = ('Left', 'Right') # Shutter options of the GUI
shutterdict = {'shutter_left' : '/PXI6259/port0/line6', # left (general) shutter
              'shutter_right' : '/PXI6259/port0/line1', # flip mirror or right shutter, depending on physical configuration
              }
...
stage_parameters = {'stage_type' : 'PI_1controllerNstages', # e.g. 'DemoStage', 'PI_1controllerNstages', 'PI_NcontrollersNstages', or 'TigerASI', see above
                    'y_load_position': 60000,
                    ...
                    'theta_max' : 999,
                    'theta_min' : -999,
                    'x_rot_position': 22500,
                    'y_rot_position': 10000,
                    'z_rot_position': 22500,
                    }

pi_parameters = {'controllername' : 'C-884',
                 'stages' : ('M-112K033','L-406.40DG10','M-112K033','M-116.DG','M-605.2DD','NOSTAGE'),
                 'refmode' : ('FRF',),
                 'serialnum' : ('119046748'),
                 }
...
'''
filterwheel_parameters = {'filterwheel_type' : 'Ludl', # 'Demo', 'Ludl', 'Dynamixel'
                          'COMport' : 'COM5',
...
filterdict = {'Empty-Alignment' : 0, # Every config should contain this
              '405-488-561-647-Quadrupleblock' : 1,
              '480/30' : 2,
              '525/30' : 3,
              '540/21' : 4,
              '580/30' : 5,
...
'filter' : '405-488-561-647-Quadrupleblock',
'etl_l_delay_%' : 7.5,
...
'etl_r_offset' : 2.36,
'galvo_l_frequency' : 199.58,
'galvo_l_amplitude' : 4,
'galvo_l_offset' : -0.3,
'galvo_l_duty_cycle' : 50,
'galvo_l_phase' : 0,
'galvo_r_frequency' : 199.58,
'galvo_r_amplitude' : 4,
'galvo_r_offset' : 0.33,
