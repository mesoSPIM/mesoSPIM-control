''' Benchtop mesoSPIM config file for long-exporure 200 ms and no-ASLM mode.
Maximizes the SNR at the cost of axial resolution.
'''
...
camera_parameters = {'x_pixels' : 5056,
                     ...
                     'subsampling' : [1,2,4],
                     'speed_table_index': 0,
                     'exp_mode' : 'Edge Trigger', # Lots of options in PyVCAM
                     'readout_port': 0,
                     'gain_index': 1,
                     ...
                     'scan_line_delay' : 0, # 10.26 us x factor, a factor = 6 equals 71.82 us
                    }
