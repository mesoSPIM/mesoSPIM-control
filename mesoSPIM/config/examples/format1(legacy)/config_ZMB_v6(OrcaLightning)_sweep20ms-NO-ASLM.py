...
OME_Zarr_Writer = {
    ...
    'base_chunks': (32,2592//2, 4608//4), # Tuple specifying starting chunk size (multiscale level 0). Bigger chunks, less files (axes: z,y,x)
...
'average_frame_rate': 22, # theoretical
}
