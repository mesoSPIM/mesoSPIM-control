...
def main():
    ...
    # Send right of the input, on its line; under them Configure and every other button on one line, in
    # this order.
    ...
    row = (tab.setup_toggle, tab.connect_button, tab.interrupt, tab.clear_button, tab.stop_button)
