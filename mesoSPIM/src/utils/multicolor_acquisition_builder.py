...
class MulticolorTilingAcquisitionListBuilder():
    ...
    def __init__(self, dict):
        ...
        '''
        Following if conditions formulate the order of loops (which loop goes first).
        '''
    ...
    def determine_light_side(self):
        image_size = self.dict['image_size']
        x_start = self.x_pos - image_size[0]/2
        x_end = self.x_pos + image_size[0]/2
