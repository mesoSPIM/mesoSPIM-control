...
from .mesoSPIM_Stages import mesoSPIM_PIstage, mesoSPIM_PI_xyzf_Stages, mesoSPIM_DemoStage, mesoSPIM_GalilStages, mesoSPIM_PI_f_rot_and_Galil_xyz_Stages, mesoSPIM_PI_rot_and_Galil_xyzf_Stages, mesoSPIM_PI_rotz_and_Galil_xyf_Stages, mesoSPIM_PI_rotzf_and_Galil_xy_Stages
...
class mesoSPIM_Serial(QtCore.QObject):
    ...
    def __init__(self, parent):
        ...
        elif self.cfg.stage_parameters['stage_type'] == 'PI_xyzf':
            self.stage = mesoSPIM_PI_xyzf_Stages(self)
