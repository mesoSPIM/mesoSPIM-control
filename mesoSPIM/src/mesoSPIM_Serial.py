...
class mesoSPIM_Serial(QtCore.QObject):
    ...
    * **Zoom** — one of the :class:`DynamixelZoom` / :class:`MitutoyoZoom` /
    ...
    def __init__(self, parent):
        ...
        elif is_demo(self.cfg.filterwheel_parameters['filterwheel_type']): # 'Demo', 'DemoFilterWheel', ...
        ...
        elif is_demo(self.cfg.zoom_parameters['zoom_type']): # 'Demo', 'DemoZoom', ...
        ...
        #     self.parent.sig_progress.connect(self.stage.log_slice)
            ...
            self.parent.sig_progress.connect(self.stage.log_slice)
        elif is_demo(self.cfg.stage_parameters['stage_type']): # 'Demo', 'DemoStage', ...
