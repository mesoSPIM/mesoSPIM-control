...
TCP and MCP expose the same 56 commands. They use the same names, arguments, limits, operation
...
The concise [Remote Control call list](calls.md) names all 56 calls and explains
