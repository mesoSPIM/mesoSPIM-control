...
1. The one-operation rule coordinates remote clients. Work started from the GUI is honoured as
   far as Core's state shows it: during a GUI acquisition or snap every mutation is refused, and
